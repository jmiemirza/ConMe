...
# num_samples = 333
# job_name = f"{partition}_{num_samples}"
eval_dataset = 'LN_FINETUNE'
partition = f"ln_finetune"
job_name = f"ln_finetune"
output_root = f'/dccstor/leonidka1/irenespace/gpt4v_results/desc/step6/{job_name}/'
...
# command related
# command = f'export TRANSFORMERS_CACHE=/dccstor/leonidka1/irenespace/.cache; python -m prompt_negatives.prompt_gpt4v --partition {partition} --pipeline_step 6 --gpt4v_type desc --job_name {job_name} --num_samples {num_samples}'
command = f'export TRANSFORMERS_CACHE=/dccstor/leonidka1/irenespace/.cache; python -m prompt_negatives.prompt_gpt4v --eval_dataset {eval_dataset} --partition {partition} --pipeline_step 6 --gpt4v_type desc --job_name {job_name}'
