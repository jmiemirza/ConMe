...
eval_vlm = 'llava-v1.6-7b'
prompt_model = 'vlm'
filter_dataset = 'SAMPLE_NEG_UPDATED'
partition = 'replace_att'
output_root = '/dccstor/leonidka1/irenespace/vlm_results_updated/eval/ed_MODEL_SPEC_UPDATED_LLM_fd_SAMPLE_NEG_UPDATED_ev_llava-v1.6-7b_dp_replace_att_wn_new_neg_s_loss_score_t_0_nt_128_p_11/eval_model_spec/replace_att_llava-v1.6-7b/'
# output_root = '/dccstor/leonidka1/irenespace/llm_results_updated/eval/llava-mix/ed_MODEL_SPEC_UPDATED_LLM_fd_llava-mix_ev_llava-v1.6-7b_wn_orig_neg_s_loss_score_t_0_nt_128_p_11/eval_model_spec/llava-mix_llava-v1.6-7b/'
...
number_of_jobs = 10
mem = '50g'
gpu_type = '' # && hname!=cccxc451 && hname!=cccxc441'

# command related
command = f'export TRANSFORMERS_CACHE=/dccstor/leonidka1/irenespace/.cache; python -m prompt_negatives.prompt_labels_llm --prompt_model {prompt_model} --eval_vlm {eval_vlm} --filter_dataset {filter_dataset} --partition {partition}'
