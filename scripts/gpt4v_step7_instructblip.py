...
# command related
command = f'export TRANSFORMERS_CACHE=/dccstor/leonidka1/irenespace/.cache; python -m prompt_negatives.vlm_eval_gpt4v --gpt4v_type desc --gpt4v_dataset_step 6 --eval_dataset GPT4V_EVAL --dataset_partition {partition} --select_by {select_by} --model {model} --experiment_name {experiment_name} --job_name {model}'
