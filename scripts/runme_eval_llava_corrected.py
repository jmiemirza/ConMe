...
params_enum['eval_dataset'] = ['ed', 'MODEL_SPEC_UPDATED_LLM'] # llava_mix
params_enum['filter_dataset'] = ['fd', 'llava-mix'] # llava-mix or SAMPLE_NEG_UPDATED
params_enum['model'] = ['ev', 'llava-v1.5-7b']
# params_enum['dataset_partition'] = ['dp', 'replace_obj']
params_enum['which_neg'] = ['wn', 'orig_neg'] # orig_neg or new_neg
params_enum['select_by'] = ['s', 'loss_score'] # generate or loss_score
...
output_root = '/dccstor/leonidka1/irenespace/llm_results_updated/eval/llava-mix'
# output_root = '/dccstor/leonidka1/irenespace/vlm_results_updated/eval/'
job_name = 'llava-mix_llava-v1.5-7b'
model_path = "liuhaotian/llava-v1.5-7b"
# model_path = "liuhaotian/llava-v1.6-vicuna-7b"
prompt_model = 'llm'
# output_root = '/dccstor/leonidka1/irenespace/llm_results_updated/eval/mistral/perp/'
...
command = f'export TRANSFORMERS_CACHE=/dccstor/leonidka1/irenespace/.cache; {cmd_prefix} eval.py --experiment_name eval_model_spec --job_name {job_name} --model_path {model_path} --prompt_model {prompt_model}'
