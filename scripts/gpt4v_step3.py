...
job_name = "ln_finetune"
output_root = f'/dccstor/leonidka1/irenespace/gpt4v_results/desc/step3/{job_name}/'
...
# command related
# command = f'export TRANSFORMERS_CACHE=/dccstor/leonidka1/irenespace/.cache; python -m prompt_negatives.prompt_gpt4v --partition {partition} --pipeline_step 3 --gpt4v_type desc --job_name {job_name} --num_samples {num_samples}'
command = f'export TRANSFORMERS_CACHE=/dccstor/leonidka1/irenespace/.cache; python -m prompt_negatives.prompt_gpt4v --eval_dataset {eval_dataset} --pipeline_step 3 --gpt4v_type desc --job_name {job_name}'
