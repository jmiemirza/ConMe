...
params_enum['model'] = ['m', 'llava-v1.6-7b'] #sandstone_flan_generic_basewatson_v2 # 'google/flan-t5-base' 'google/flan-t5-large' 'google/flan-t5-xl'
...
params_enum['select_by'] = ['s', 'generate'] # generate, loss_score, or t2i
...
# command related
command = f'export TRANSFORMERS_CACHE=/dccstor/leonidka1/irenespace/.cache; {cmd_prefix}  eval.py --experiment_name baseline --job_name {job_name} --model_path {model_path}'
