...
# command related
command = f'export TRANSFORMERS_CACHE=/dccstor/leonidka1/irenespace/.cache; python -m prompt_negatives.vlm_eval_gpt4v --gpt4v_type desc --gpt4v_dataset_step 3 --eval_dataset GPT4V_EVAL --dataset_partition {partition} --select_by {select_by} --model {model} --model_path {model_path} --temperature 0 --max_new_tokens 128 --prompt 11 --experiment_name {experiment_name} --job_name {model}'
