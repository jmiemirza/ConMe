...
# params_enum['partition'] = ['p', 'replace_obj', 'replace_att', 'replace_rel']
# params_enum['num_samples'] = [333]
...
# num_samples = 333
# output_root = f'/dccstor/leonidka1/irenespace/gpt4v_results/desc/step1/{partition}_{num_samples}/'
eval_dataset = 'LN_FINETUNE'
output_root = f'/dccstor/leonidka1/irenespace/gpt4v_results/desc/step1/ln_finetune'
...
# command related
# command = f'export TRANSFORMERS_CACHE=/dccstor/leonidka1/irenespace/.cache; python -m prompt_negatives.prompt_gpt4v --partition {partition} --pipeline_step 1 --gpt4v_type desc --num_samples {num_samples}'
command = f'export TRANSFORMERS_CACHE=/dccstor/leonidka1/irenespace/.cache; python -m prompt_negatives.prompt_gpt4v --eval_dataset {eval_dataset} --pipeline_step 1 --gpt4v_type desc'
