...
# command related
command = f'export TRANSFORMERS_CACHE=/dccstor/leonidka1/irenespace/.cache; python -m prompt_negatives.vlm_gen_gpt4v --gpt4v_type desc --gpt4v_dataset_step 3 --eval_dataset GPT4V_VLM_GEN --dataset_partition {partition} --select_by generate --max_new_tokens 128 --model {model} --experiment_name {experiment_name} --job_name {model}'
