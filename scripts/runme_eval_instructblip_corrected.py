...
params_enum['model'] = ['ev', 'instructblip_vicuna_7b']
# params_enum['filter_vlm'] = ['fv', 'instructblip_flan_t5']
params_enum['dataset_partition'] = ['dp', 'replace_rel']
params_enum['which_neg'] = ['wn', 'new_neg']
...
output_root = '/dccstor/leonidka1/irenespace/llm_results_updated/eval'
...
command = f'export TRANSFORMERS_CACHE=/dccstor/leonidka1/irenespace/.cache; {cmd_prefix} eval.py --experiment_name eval_model_spec'
