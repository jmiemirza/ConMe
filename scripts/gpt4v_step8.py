...
output_root = f'/dccstor/leonidka1/irenespace/gpt4v_results/desc/'
...
# command related
command = f'export TRANSFORMERS_CACHE=/dccstor/leonidka1/irenespace/.cache; python -m prompt_negatives.validate_yes_no_gpt4v --dataset_step step7 --partition {partition} --model {model} --results_type filter'
