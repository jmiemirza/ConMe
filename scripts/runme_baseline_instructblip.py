...
params_enum['model'] = ['m', 'gpt4v'] #instructblip_flan_t5, instructblip_vicuna_7b, internlm_xcomposer_vl_7b, idefics2-8b
params_enum['eval_dataset'] = ['ed', 'SUGAR'] # llava_mix
# params_enum['eval_vlm'] = ['ev', 'llava-v1.5-7b']
# params_enum['filter_vlm'] = ['fv', 'instructblip_flan_t5']
# params_enum['dataset_partition'] = ['dp', 'replace_att']
params_enum['select_by'] = ['s', 'generate'] # generate, loss_score, t2i
...
# output_root = '/dccstor/leonidka1/irenespace/llm_results_updated/filter/llava-v1.5-7b/'
output_root = '/dccstor/leonidka1/irenespace/sugar_results/corrected_templates/'
# job_name = 'vgr_instructblip_flan_t5'
job_name = 'sugar_gpt4v'
...
# command related
command = f'export TRANSFORMERS_CACHE=/dccstor/leonidka1/irenespace/.cache; {cmd_prefix}  eval.py --experiment_name baseline --job_name {job_name}'
