...
# command related
command = f'export TRANSFORMERS_CACHE=/dccstor/leonidka1/irenespace/.cache; python -m prompt_negatives.vlm_gen_gpt4v --gpt4v_type desc --eval_dataset GPT4V_VLM_GEN --gpt4v_dataset_step 1 --dataset_partition {partition} --select_by generate --max_new_tokens 500 --model {model} --experiment_name {experiment_name} --job_name {model}'
