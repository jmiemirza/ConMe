...
output_root = '/dccstor/leonidka1/irenespace/llm_results_updated/negs/SUGAR_replace_obj/'
...
# command related
command = f'export TRANSFORMERS_CACHE=/dccstor/leonidka1/irenespace/.cache; python prompt_negatives_llm.py --eval_dataset SUGAR --partition replace_obj'
