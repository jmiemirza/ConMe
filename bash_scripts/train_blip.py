...
params_enum['experiment_name'] = ['exp', 'new_datasets']
params_enum['lora_r'] = ['lora', 16, 32]
params_enum['finetune_dataset_csv'] = [
    'data',
...
base_root = "/dccstor/leonidka1/victor_space"
scratch_root = f"{base_root}/scratch/train_dec_results/checkpoint_logs/{params_enum['experiment_name'][-1]}"
...
command = f'python {base_root}/dec-vl-eval/train.py'
