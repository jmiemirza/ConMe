...
MODEL_REGISTRY={
    "instructblip": {
        ...
        "model_type": "mllm",
        "tokenizer": InstructBlipProcessor,
...
class MLLM_Tester(nn.Module):
    ...
    def process_prompt(self, question):
        ...
        # return question # DEBUGGING SEED-BENCH: if already formatted with multiple choice options
    ...
    def forward(self, x):
        ...
        if data_type == 'image':
            ...
            for j in range(image.size(2)):
                ...
                frame_inputs_t5 = self.model.language_projection(
        ...
        with torch.cuda.amp.autocast(dtype=torch.bfloat16):
            ...
            for choice in choices:
                output_tokenized = self.tokenizer.tokenizer(text=choice, return_tensors='pt', padding="longest",
                                                            truncation=True).to(image.device)
        ...
        return torch.stack(losses), gen_text
