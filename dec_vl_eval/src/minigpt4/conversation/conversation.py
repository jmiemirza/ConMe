...
#  no system prompt for minigptv2
...
CONV_VISION_minigptv2_for_perplexity = Conversation(
    system="",
    roles=("", ""),
    messages=[],
    offset=2,
...
class Chat:
    ...
    def answer(self, conv, img_list, **kargs):
        generation_dict = self.answer_prepare(conv, img_list, **kargs)  # get the configuration
