...
def prompt(
    ...
    for key, samples in data_dict.items():
        ...
        output_dir = f"/dccstor/leonidka1/irenespace/llm_results/classify_{args.choice}" + (
        ...
        for ind, sample in enumerate(samples):
            ...
            save_fn = f"{output_dir}/classify_{key}_sample-{ind:04d}.csv"
            ...
            curr_dict = {
                ...
                'classify_choice': to_classify,  # either orig or new
                'orig_pos': pos,  # original positive
                'orig_neg': neg,  # original negative
                'new_neg': new_neg,
                'new_change': sample[8],
                'contradiction_check_llm': sample[9],
                'contradiction_input': contradictions, # either newly generated for orig sample, or same as contradiction_check_llm
